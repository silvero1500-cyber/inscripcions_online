...
return [
    ...
    'form.chip.yes'                    => 'Sí',
    'form.chip.no'                     => 'No, necessito xip de cessió',
    ...
    'event.access.wrong'               => 'Contrasenya incorrecta.',
    'event.access.expired'             => 'La sessió ha expirat. Torna-ho a provar.',
    'event.access.rate_limited'        => 'Massa intents. Espera uns minuts i torna-ho a provar.',
    'event.access.required'            => "Cal introduir la contrasenya d'accés abans d'inscriure't.",
    ...
    'form.consent.accept'              => "He llegit i accepto la",
    'form.consent.and'                 => "i el",
    'form.consent.reglament'           => 'reglament',
    'form.privacy.required'            => "Has d'acceptar la política de privacitat per continuar.",
    'incidencia.button'                => 'Reportar una incidència',
    'incidencia.help'                  => 'Has tingut algun problema amb la inscripció? Explica-ho i ho revisarem.',
    'incidencia.placeholder'           => 'Descriu la incidència…',
    'incidencia.send'                  => 'Enviar',
    'incidencia.email_label'           => 'El teu correu electrònic (opcional, per poder respondre)',
    'incidencia.recover_notice'        => 'Si és perquè no has rebut el correu de confirmació, pots recuperar-lo tu mateix',
    'incidencia.recover_link'          => 'aquí posant el teu correu o DNI.',
