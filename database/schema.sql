...
-- ------------------------------------------------------------
-- 12. LISTA DE ESPERA (avisos quan s'allibera plaça)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 14. TIENDA (botiga: productes, variacions, comandes)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 18. AUDIT_LOG (auditoria de seguretat: login, usuaris, eventos, exports, config)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- PREFERÈNCIES D'INTERFÍCIE PER USUARI (ex: columnes del grid d'inscrits)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- INCIDENCIES (bústia del formulari públic)
-- ------------------------------------------------------------
